     	...
     	<div class="container-fluid">
     		...
     		<div class="collapse navbar-collapse">
     			<ul class="nav navbar-nav">
     				<li class="active"><a href="index.php"><i class="glyphicon glyphicon-home"></i>Dashboard</a>
     				</li>
     				...
     				<li class="dropdown">
     					...
     					aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-wrench"></i>
